...
def calc_n_regions(
    ...
    Args:
        flood_regions_net (FloodRegions): A network of flood regions used for path analysis.
        env_map (chex.Array): The environment map representing the maze layout.
        passable_tiles (chex.Array): An array of tiles that can be ignored (e.g., DungeonTiles.EMPTY, DungeonTiles.KEY).

    Returns:
        Tuple[chex.Array, chex.Array]: A tuple containing processed flood region data and computed diameter information.
    """
